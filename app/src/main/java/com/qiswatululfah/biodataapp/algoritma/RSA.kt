package com.qiswatululfah.biodataapp.algoritma
...
class RSA {
    ...
    fun encrypt(plain: Char, e: Double, n: Int): String {
        ...
        val plainPangkatE = Math.pow(numberAscii.toDouble(), e)
        ...
        val cipherASCII = plainPangkatE % n
        ...
        val cipher = cipherASCII.toChar()
        Log.d("Encrypt", "Cipher value $cipher")
